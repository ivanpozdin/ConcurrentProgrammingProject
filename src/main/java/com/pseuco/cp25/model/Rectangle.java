...
public class Rectangle implements Iterable<XY> {
    ...
    @JsonCreator
    public Rectangle(
            @JsonProperty(value = "topLeft", required = true) final XY topLeft,
            @JsonProperty(value = "size", required = true) final XY size) {
    ...
    public boolean overlaps(Rectangle other) {
        return !(this.bottomRight.getX() <= other.topLeft.getX()
     ...
     *
     * <p>
     * Hint: You may want to use this method to compute which parts of the area
     * owned by a patch need to be synchronized with the padding of another
     * patch.
     * </p>
     *
     * @param other The other rectangle.
    ...
    public boolean contains(XY cell) {
        return (this.topLeft.getX() <= cell.getX()
