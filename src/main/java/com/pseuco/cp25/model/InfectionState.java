...
/**
 * Represents the state of a person including how long it has been in that
 * state.
 */
public class InfectionState {
    ...
    public InfectionState(
            @JsonProperty(value = "type", required = true) final State state,
            @JsonProperty(value = "since", defaultValue = "0") final int inStateSince) {
        this.state = state;
    ...
    public boolean equals(Object other) {
        ...
        return (this.state == infectionState.state
