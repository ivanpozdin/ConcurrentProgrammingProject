...
/**
 * Represents a two-dimensional vector with an <em>x</em>- and a
 * <em>y</em>-component.
 *
...
public class XY {
    ...
    @JsonCreator
    public XY(
            @JsonProperty(value = "x", required = true) final int x,
            @JsonProperty(value = "y", required = true) final int y) {
        this.x = x;
        this.y = y;
    }
    ...
    /**
     * Subtracts the specified scalars from the respective components of the
     * vector.
     *
    ...
    /**
     * Subtracts the specified scalar from both components of the vector.
     *
