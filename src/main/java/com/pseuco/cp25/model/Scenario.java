...
public class Scenario {
    ...
    public Scenario(
            ...
            @JsonProperty(value = "parameters", required = true) final Parameters parameters,
            @JsonProperty(value = "ticks", required = true) final int ticks,
            @JsonProperty(value = "gridSize", required = true) final XY gridSize,
            @JsonProperty(value = "trace", required = true) final boolean trace,
            @JsonProperty(value = "partition", required = true) final Partition partition,
            @JsonProperty(value = "obstacles", required = true) final List<Rectangle> obstacles,
            @JsonProperty(value = "statQueries", required = true) final Map<String, Query> queries,
            @JsonProperty(value = "population", required = true) final List<PersonInfo> population) {
        this.name = name;
