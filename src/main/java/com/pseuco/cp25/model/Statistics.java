...
public class Statistics {
     ...
     */
    public Statistics(
            @JsonProperty(value = "susceptible", required = true) final long susceptible,
            @JsonProperty(value = "infected", required = true) final long infected,
            @JsonProperty(value = "infectious", required = true) final long infectious,
            @JsonProperty(value = "recovered", required = true) final long recovered) {
    ...
    public String toString() {
        return String.format(
                "Statistics(%d, %d, %d, %d)", this.susceptible, this.infected, this.infectious, this.recovered
        );
    }
    ...
    public boolean equals(Object other) {
        ...
        return (this.susceptible == otherStatistics.susceptible
