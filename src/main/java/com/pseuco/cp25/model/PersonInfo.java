 ...
 *
 * Note that this is a mere data container holding information about a person
 * but does not contain any simulation functionality.
 */
public class PersonInfo {
    ...
    public PersonInfo(
            ...
            @JsonProperty(value = "pos", required = true) final XY position,
            @JsonProperty(value = "rngState", required = true) final byte[] seed,
            @JsonProperty(value = "infectionState", required = true) final InfectionState infectionState,
    ...
    public boolean equals(Object other) {
        ...
        return (this.name.equals(personInfo.name)
                && this.position.equals(personInfo.position)
                && Arrays.equals(this.seed, personInfo.seed)
