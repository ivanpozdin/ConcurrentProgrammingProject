...
public class Utils {
    ...
    /**
     * Computes whether it is possible to propagate information from a
     * <em>source area</em>
     * to a <em>target area</em> after an arbitrary amount of ticks.
     *
     * You may use this method to check whether it is possible to propagate
     * information from the padding of a patch inside the area owned by the
     * patch. If you do not want to use this method make sure your method is as
     * least as precise as this method.
     *
     * For those who would like to earn a bonus: In some cases this method
     * returns that information may propagate although on closer inspection this
     * is not the case. What are those cases? Can you improve on that?
     *
     * @param scenario The scenario to check for obstacles and use the
     * parameters from.
     * @param source The <em>source area</em> for which to check the propagation
     * possibility.
     * @param target The <em>target area</em> for which to check the propagation
     * possibility.
     * @return Whether information may propagate from the <em>source</em> to the
     * <em>target area</em>.
     */
